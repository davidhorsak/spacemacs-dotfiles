...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  (add-to-list 'exec-path "/Users/dh/.npm-global/bin" t)
)
...
before packages are loaded."
  (defun my-setup-indent (n)
    ...
    (setq web-mode-attr-indent-offset n) ; force indentation of attributes on the next line
    (setq css-indent-offset n) ; css-mode
    (setq json-encoding-default-indentation n) ;json files
    (setq json-reformat:indent-width n) ;json reformat
    )
  (my-setup-indent 2) ;
)
